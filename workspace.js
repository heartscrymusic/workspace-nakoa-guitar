...
cprequire_test(["inline:com-chilipeppr-workspace-nakoa"], function(ws) {
    ...
    $('title').html("Nakoa Woodworks Workspace");
    $('body').css('padding', '10px');

} /*end_test*/ );

// This is the main definition of your widget. Give it a unique name.
cpdefine("inline:com-chilipeppr-workspace-nakoa", ["chilipeppr_ready"], function() {
    return {
        /**
         * The ID of the widget. You must define this and make it unique.
         */
        id: "com-chilipeppr-workspace-nakoa", // Make the id the same as the cpdefine id
        name: "Nakoa Woodworks Workspace", // The descriptive name of your widget.
        ...
        loadWidgets: function(callback) {
            ...
            */
            ...
            chilipeppr.load("#com-chilipeppr-ws-gcode-dragdrop",
                "http://raw.githubusercontent.com/heartscrymusic/elem-dragdrop/master/auto-generated-widget.html",
                function() {
